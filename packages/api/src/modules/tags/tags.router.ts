...
import { CreateTagSchema, GetTagsQuerySchema, TagIdParamSchema } from './tags.schema'

const router = Router()

router.get('/', requireAuth, validate(GetTagsQuerySchema, 'query'), tagsController.getAll)
